...
// Image constants
const home1 = '/images/home1.png';
const home2 = '/images/home2.png';
const home3 = '/images/home3.png';
...
const shadyGrayCollectionImg = '/images/shady-gray.webp';
const whiteShakerBanner = '/images/white-shaker-banner.jpg';
const francoWhiteShakerDoor = '/images/Franco-Collection-White-Shaker-(Framed)-Sample-Door-.jpg';
const grayShakerbanner = '/images/Gray-Shaker-frameless-banner.jpg';
const mallorcaDolphingrayDoor = '/images/Mallorca-Collection-Dolphin-Gray-(Frameless).jpg';
const shorelineWoodgrainBanner = '/images/Shoreline-Woodgrain-banner.jpg';
const newportShorelineDoor = '/images/Newport-Collection-Shoreline-(Frameless)-Sample-Door.jpg';
const aspenStoneGrayBg = '/images/aspen-collection-stone-gray-background.jpg';
const aspenStoneGrayDoor = '/images/Aspen-Collection-Stone-Gray-(Frameless)-Sample-Door.jpg';
const slimBlack = '/images/Slim-Black.jpg';
const francoSlimBlackDoor = '/images/Franco-Collection-Slim-Black-(Framed)-Sample-Door-.jpg';
const naturalOakBanner = '/images/Natural-Oak-banner.jpg';
const newportNaturalOakDoor = '/images/Newport-Collection-Natural-Oak-(Frameless)-Sample-Door.jpg';
