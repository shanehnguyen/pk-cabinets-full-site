...
// Image constants
const mallorcaWhite = '/images/mallorca-white.webp';
const mallorcaGray = '/images/mallorca-gray.webp';
const shadyWhite = '/images/shady-white.webp';
const shadyGray = '/images/shady-gray.webp';
const shadyNatural = '/images/shady-natural.webp';
const francoWhite = '/images/franco-white.webp';
const francoGray = '/images/franco-gray.webp';
const francoOak = '/images/franco-oak.webp';
const francoSlimWhite = '/images/franco-slim-white.webp';
const francoBlack = '/images/franco-black.webp';
const francoSlimOak = '/images/franco-slim-oak.webp';
const irenaWhite = '/images/irena-white.webp';
const irenaGray = '/images/irena-gray.webp';
const irenaOlive = '/images/irena-olive.webp';
const irenaGlossyWhite = '/images/irena-glossy-white.webp';
const irenaWoodgrains = '/images/irena-woodgrains.webp';
const newportOak = '/images/newport-oak.webp';
const newportUmbria = '/images/newport-umbria.webp';
const newportShoreline = '/images/newport-shoreline.webp';
const aspenGray = '/images/aspen-gray.webp';
const aspenEmerald = '/images/aspen-emerald.webp';
const aspenRaven = '/images/aspen-raven.webp';
